...
public record ApprovalRecord(String id, String executionId, String toolName, String params, String status,
                             String approvedBy,
    ...
    public ApprovalRecord status(String next) {
        return new ApprovalRecord(id, executionId, toolName, params, next, approvedBy, expiresAt, requesterUserId, datasetId, conversationId);
    }

    public ApprovalRecord decided(String next, String userId) {
        return new ApprovalRecord(id, executionId, toolName, params, next, userId, expiresAt, requesterUserId, datasetId, conversationId);
    }
}
